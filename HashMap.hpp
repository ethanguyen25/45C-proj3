...
public:
    ...
    unsigned int getBucketNumber(const std::string& key) const;
...
private:
    ...
    unsigned int numOfBuckets;  //bucketCount()
    Node** hashTable;  //array of linked list(Nodes)

private:
    void properCopy(Node** hashTable, const HashMap& hm);
